...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 05. Mrz 2018 um 22:40
...
--
-- Datenbank: `cr9_ayse_uluc_carrent`
--
...
(1, 'Rocher', 'Molan', 25, 'r.molan@live.at', 6),
(2, 'James', 'Doe', 46, 'j.d@live.at', 69910246);
...
(1, 1, 1, '2018-03-05 19:55:28'),
(2, 2, 2, '2018-03-05 19:55:28');
...
(1, 'Langobardenstraße 4', 'no comment'),
(2, 'Donaustradtstraße', 'no comment');
...
(1, 1, 1, '2018-03-05 19:57:46'),
(2, 2, 2, '2018-03-05 19:57:46');
...
(1, 1, '2018-03-14', '2018-03-17'),
(2, 2, '2018-03-28', '2018-03-31');
...
ALTER TABLE `drop_off`
  ...
  ADD KEY `drop_off_ibfk_2` (`fk_endlocation_id`);
...
--
ALTER TABLE `additional_charges`
  ADD CONSTRAINT `additional_charges_ibfk_1` FOREIGN KEY (`fk_reason_id`) REFERENCES `reason_for_extracarge` (`reason_id`),
  ADD CONSTRAINT `additional_charges_ibfk_2` FOREIGN KEY (`fk_drop_off_id`) REFERENCES `drop_off` (`drop_off_id`);
...
--
ALTER TABLE `pick_up`
  ADD CONSTRAINT `pick_up_ibfk_1` FOREIGN KEY (`fk_startlocation_id`) REFERENCES `startlocation` (`startlocation_id`),
